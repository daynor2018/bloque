...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="{{asset('bloque/mdbfr/css/bootstrap.min.css')}}" rel="stylesheet">
  <!-- Material Design Bootstrap -->
  <link href="{{asset('bloque/mdbfr/css/mdb.min.css')}}" rel="stylesheet">
  <!-- Your custom styles (optional) -->
  <link href="{{asset('bloque/mdbfr/css/stylepublication.css')}}" rel="stylesheet">
</head>
